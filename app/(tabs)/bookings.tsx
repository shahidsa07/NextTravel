...
const getStyles = (COLORS, FONTS, SIZES) => StyleSheet.create({
    ...
    tabContainer: { flexDirection: 'row', backgroundColor: '#f2f2f7', borderRadius: SIZES.radius, padding: 4, marginVertical: SIZES.padding },
    tabWrapper: { flexDirection: 'row', justifyContent: 'space-between', flex: 1, backgroundColor: '#f2f2f7', borderRadius: SIZES.radius },
